...
public class AdminProfileSettings extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        lblConfirmPass = findViewById(R.id.user_txt_confirm_pass);
        cardView_confirm_pass = findViewById(R.id.card_re_pass);

        txtFullName = findViewById(R.id.user_txt_full_name);
        txtUserType = findViewById(R.id.user_txt_user_type);
        txtUsername = findViewById(R.id.user_txt_username);
        txtPassword = findViewById(R.id.user_txt_pass);
        txtConPassword = findViewById(R.id.user_txt_repass);

        fab_edit_user = findViewById(R.id.fab_edit_profile);
        fab_save_user = findViewById(R.id.fab_save_profile);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home){
            if (isEditing){
                ...
                startActivity(new Intent(AdminProfileSettings.this, AdminForm.class));
                finish();
            }
        }
